...
<html lang="en">
  ...
  <body>
    ...
    @if (session()->has('success'))  
      {{-- if session has a flash message with name success --}}
    ...
    {{-- if session has a flash message with name failure --}}
    ...
    {{$slot}}  
    {{-- dynamic data which displays according to the situation --}}
